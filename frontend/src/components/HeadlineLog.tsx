...
import { fetchHeadlines } from "../lib/fetchData";

import type { HeadlineRow } from "../lib/fetchData";
...
const HeadlineLog = () => {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      const rawData = await fetchHeadlines(page, pageSize);
